...
After completing a calculation, the final calculated value needs to be rounded to the appropriate number of significant figures. The number of significant figures or decimal places to round to was specified in the previous section. In this section, we discuss how to round a numerical value given the number of significant figures or decimal places has already been determined.
